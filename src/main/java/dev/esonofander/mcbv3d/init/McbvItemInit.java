package dev.esonofander.mcbv3d.init;

import dev.esonofander.mcbv3d.MoreChiseledBookshelfVariants3D;
import dev.esonofander.mcbv3d.block.MoreChiseledBookShelfBlock;
...
import static dev.esonofander.mcbv3d.init.McbvBlockInit.*;
...
public class McbvItemInit {
    ...
    private static void registerItem(BlockItem chiseled_bookshelf, Item chiseled_bookshelfAfter) {
        Registry.register(BuiltInRegistries.ITEM, MoreChiseledBookshelfVariants3D.asId(((MoreChiseledBookShelfBlock) chiseled_bookshelf.getBlock()).chiseledBookshelfWoodType + "_chiseled_bookshelf"), chiseled_bookshelf);
