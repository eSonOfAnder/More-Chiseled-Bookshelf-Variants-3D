...
public class McbvBlockInit {
    ...
    private static void registerBlock(MoreChiseledBookShelfBlock chiseled_bookshelf) {
        Registry.register(BuiltInRegistries.BLOCK, MoreChiseledBookshelfVariants3D.asId(chiseled_bookshelf.chiseledBookshelfWoodType + "_chiseled_bookshelf"), chiseled_bookshelf);
